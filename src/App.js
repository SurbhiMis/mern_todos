      ...
      <div className="row">
        ...
        </form>
        {
          ...
          <ul className="collection">
            {todos.map(todo=>(
              <li onClick={()=>setCurrentId(todo._id)} key={todo._id} className="collection-item"><div><h5>{todo.title}</h5><p>{todo.content}<a href="#!" onClick={()=>removeTodo(todo._id)} className="secondary-content"><i className="material-icons">delete</i></a></p></div></li>
